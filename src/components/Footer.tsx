        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/about" onClick={(e) => handleNavClick(e, "/about")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/services" onClick={(e) => handleNavClick(e, "/services")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/projects" onClick={(e) => handleNavClick(e, "/projects")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  Projects
                </Link>
              </li>
              <li>
                <Link to="/sustainability" onClick={(e) => handleNavClick(e, "/sustainability")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  Sustainability
                </Link>
              </li>
              <li>
                <Link to="/career" onClick={(e) => handleNavClick(e, "/career")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/contact" onClick={(e) => handleNavClick(e, "/contact")} className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div className="text-center lg:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block cursor-not-allowed opacity-60">
                  Blogs <span className="text-xs">(Coming Soon)</span>
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block cursor-not-allowed opacity-60">
                  Articles <span className="text-xs">(Coming Soon)</span>
                </a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-[#DDB9A2] transition-colors duration-300 text-base block cursor-not-allowed opacity-60">
                  Journals <span className="text-xs">(Coming Soon)</span>
                </a>
              </li>
            </ul>
          </div>
